...
public class Instructions_Controller extends BuildingBlockController {
    ...
    //variables needed
    private static final int bubbleSize=300;
    ...
    private static final String helloEncrypt = "Hi!! And Welcome to the Cryptography Teaching tool. I'm Encrypt and i'm the twin sister of Decrypt."+
    ...
    private static final String helloDecrypt = "Hello! I'm Decrypt and i'm the twin brother of Encrypt. This is the Welcome page and you can see the instructions via "+
    ...
    private static final Header instructions    = new Header("Welcome to the Instructions");
    private static final Header menu            = new Header("Menus");
    private static final Header buildingBlocks  = new Header("Building Blocks");
    private static final Header cryptography    = new Header("Cryptography Methods");
    private static final Header animation       = new Header("Animation Controls");

    private static final Header[] pageTitles = new Header[]{instructions,menu,buildingBlocks,cryptography,animation};

    private static final Paragraph welcome      = new Paragraph("These are the instructions. Down the bottom is a selector and some arrows. Use these to go between the instruction pages. The instructions on offer are as follows:\n"+
    ...
    private static final Paragraph menuInfo = new Paragraph("There are three menus along the top of the screen. Each of these menus allow you to access different parts of the program. They also list the keyboard shortcuts to all of the parts of the program if you prefer to use them. Here is a list of each of the menus and their contents:\n"+
