...
public class AES_Controller extends CryptoMethodsController {
    ...
    private static final String step_2_welcome  = "Hi, and welcome to Step 2. I'm going to how you how a message get encrypted using AES. We will be using a key size of 128 bits, so we will have 10 rounds in this example.";
    private static final String step_2_rounds   = "Here we have the three round i'll be describing. Round 1 has only 1 stage. Rounds 2-9 have the same 4 stages while the final round has 3 stages. Regardless of how many rounds you have, the first and final are always this way and all other rounds have 4 stages.";
    ...
    private static final String step_4_rounds       = "The rounds are the same idea as the encryption process, the first and last rounds are unique while the intermediary rounds are the same. We also have similar stages within the rounds.";
